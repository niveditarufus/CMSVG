...
class Talk2Car(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        output['sentence'] = sample['command']
        ...
        output['image'] = torch.nn.functional.interpolate(img.unsqueeze(0),(224,224)).squeeze()
...
def main():
    ...
    root = '/home/caradmin/space/QIF/Talk2Car/c4av_model/data'
    split = 'train'
    dataset = Talk2Car(root, split, './utils/vocabulary.txt', transforms.ToTensor())

    print('=> Load a sample')    
    sample = dataset.__getitem__(25)
